...
class Settings(BaseSettings):
    ...
    BACKEND_CORS_ORIGINS: List[AnyHttpUrl] = [
        "http://0.0.0.0:3000",  # type: ignore
        "http://0.0.0.0:8000",  # type: ignore
        "https://0.0.0.0:3000",  # type: ignore
        "https://0.0.0.0:8000"
         # type: ignore
    ]

    PROJECT_NAME: str = "Youth Employment in the I.T Sector Prediction API"
